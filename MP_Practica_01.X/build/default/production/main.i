...
# 725 "/Applications/microchip/xc8/v2.32/pic/include/pic18_chip_select.inc" 3
# 1 "/Applications/microchip/xc8/v2.32/pic/include/proc/pic18f4550.inc" 1 3
# 48 "/Applications/microchip/xc8/v2.32/pic/include/proc/pic18f4550.inc" 3
SPPDATA equ 0F62h
...
TOSU equ 0FFFh
# 6179 "/Applications/microchip/xc8/v2.32/pic/include/proc/pic18f4550.inc" 3
...
# 726 "/Applications/microchip/xc8/v2.32/pic/include/pic18_chip_select.inc" 2 3
...
; CONFIG3H
  ...
  CONFIG MCLRE = OFF ; MCLR Pin Enable bit (((PORTE) and 0FFh), 3, a input pin enabled; MCLR pin disabled)
...
loop:
    ...
    btg ((PORTD) and 0FFh), 0, a
    btg ((PORTD) and 0FFh), 1, a
    btg ((PORTD) and 0FFh), 2, a
    btg ((PORTD) and 0FFh), 3, a
    btg ((PORTD) and 0FFh), 4, a
    btg ((PORTD) and 0FFh), 5, a
    btg ((PORTD) and 0FFh), 6, a
    btg ((PORTD) and 0FFh), 7, a
    goto delay
